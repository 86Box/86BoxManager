...
namespace _86boxManager
{
    ...
    public class VM
    {
        ...
        {
            return "Имя: " + Name + ", Описание: " + Desc + ", Путь: " + Path + ", Статус: " + Status;
        }
        ...
        public string GetStatusString()
        {
            switch (Status)
            {
                case STATUS_STOPPED: return "Остановлено";
                case STATUS_RUNNING: return "Запущено";
                case STATUS_PAUSED: return "Приостановлено";
                case STATUS_WAITING: return "Ожидание";
                default: return "Неверный статус";
            }
        }
    }
}
