    ...
    static class Program
    {
        ...
        static void Main()
        {
            ...
            else
            {
                ...
                if (pname.Length > 0)
                {
                    DialogResult result = MessageBox.Show("Как минимум один экземпляр 86Box.exe уже запущен. Не рекомендуется запускать 86Box.exe непосредственно вне диспетчера. Вы хотите продолжить на свой страх и риск?", "Внимание", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
